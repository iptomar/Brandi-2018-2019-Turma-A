            ...
            <div className="container mb-3">
                ...
                <div className="row">
                    ...
                    <div className="col-md-2">
                        <button id="btEditar" className="btn btn-success my-3" onClick={this.changeToEdit}>Editar</button>
                    </div>
                </div>
                ...
                <table className="table table-bordered table-secondary text-center" id="tabela">
                    ...
                    <tbody>
                        <tr id="linha" data-id="">
                            <td><input id="dataL" type="date" className="form-control input" style={{ height: "63px" }} readOnly /></td>
                            <td><textarea id="dpL" className="form-control input" style={{ resize: "none" }} rows="2" placeholder="Designação do procedimento" readOnly /></td>
                            <td><textarea id="mpL" className="form-control input" style={{ resize: "none" }} rows="2" placeholder="Materiais e produtos" readOnly /></td>
                            <td><textarea id="qL" className="form-control input" style={{ resize: "none" }} rows="2" placeholder="Quantidades" readOnly /></td>
                            <td><textarea id="durL" className="form-control input" style={{ resize: "none" }} rows="2" placeholder="HH:MM" readOnly /></td>
                            <td><textarea id="tecnicoL" className="form-control input" style={{ resize: "none" }} rows="2" placeholder="Técnico" readOnly /></td>
                            <td><textarea id="obsL" className="form-control input" style={{ resize: "none" }} rows="2" placeholder="Observações" readOnly /></td>
                        </tr>
                    </tbody>
                </table>
                {/* Botões */}
                <div id="editarF" className="row" style={{ display: "none" }}>
                    ...
                    <div className="col-md-12 mt-2">
                        <button type="button" className="btn btn-success btn-lg btn-block mb-5" onClick={this.submit}>Guardar</button>
                    </div>
                </div>
            </div>
        );
