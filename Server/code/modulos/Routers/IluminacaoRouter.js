...
const iluminacao = require("../CRUDS/Iluminacao");

/**
 * Rota que retorna todas as condições ambientais
 */
exports.getAllIluminacao = async (app, bd) => {
    app.get("/api/iluminacao", async (req, resp) => {
        ...
        if (token === null) {
            ...
            let resposta_bd = await iluminacao.getAllIluminacao(bd);
            if (
                resposta_bd.stat === 1 &&
 ...
 */
exports.getIluminacao = async (app, bd) => {
    app.get("/api/iluminacao/:id", async (req, resp) => {
        ...
        if (token === null) {
            ...
            let resposta_bd = await iluminacao.getSingleIluminacao(bd, req.params.id);
            if (
                resposta_bd.stat === 1 &&
                resposta_bd.resposta === "DBConnectionError"
            ) {
 ...
 */
exports.createIluminacao = async (app, bd) => {
    app.post("/api/iluminacao/create", async (req, resp) => {
        ...
        if (token === null) {
            ...
            let resposta_bd = await iluminacao.createIluminacao(bd, dados);
 ...
 */
exports.updateIluminacao = async (app, bd) => {
    app.post("/api/iluminacao/:id/edit", async (req, resp) => {
        ...
        if (token === null) {
            ...
            let resposta_bd = await iluminacao.updateIluminacao(bd, dados);
            console.log(resposta_bd);
            if (resposta_bd.stat === 0) {
