...
import EditTestesSolubilizacao from './MasterComponents/TestesSolubilizacao/EditTestesSolubilizacao';
...
ReactDOM.render(
    <BrowserRouter>
        <Switch>
            ...
            <Route path="/testesSolubilizacao/:id/detalhes" component={(r) => <EditTestesSolubilizacao id={r.match.params.id} />} />
            {/* Default */}
