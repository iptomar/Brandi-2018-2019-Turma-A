  ...
  render() {
    ...
    if (sessionStorage.getItem('token') == null) {
      ...
      for (let index = 0; index < this.state.list.length; index++) {
        visualList += `<div class="card" style="width: 18rem;"><img src="http://portal2.ipt.pt/img/logo.png" class="card-img-top" ><div class="card-body"><a href="/fichaRI/detalhes/${this.state.list[index].fichaRegistoID}" class="card-title">${this.state.list[index].designacao}</a></div></div>`;
      }
      visualList+=`</div>`;
    }else{
